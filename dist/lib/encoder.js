...
bignumber_js_1.default.config({ RANGE: [-30, 30], EXPONENTIAL_AT: 1e9 });
bignumber_js_1.default.set({ DECIMAL_PLACES: 30, ROUNDING_MODE: bignumber_js_1.default.ROUND_DOWN }); // equivalent
function Encoder(type, value) {
    ...
    const encodeFloat = (val) => {
        ...
        if (!bignumber_js_1.default.isBigNumber(val))
            val = new bignumber_js_1.default(val);
...
Encoder.BigNumber = bignumber_js_1.default;
